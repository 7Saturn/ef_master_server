...
public static class QueryStrings {
    ...
    private static void CreateMapping() {
        ...
        byte[] server_list_response_head = ConcatByteArray(new byte[][] {yyyy, getserversResponse, space});
	...
	public static byte[] GetArray(string name) {
        ...
        if (!mapping.TryGetValue(name, out return_string)) {
			throw new StringNameInvalidException("There is no server query with that name.");
		} else {
